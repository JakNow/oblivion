...
public class Transform {
    ...
    public Transform(Vector3f position, Quaternionf rotation, Vector3f scale, List<GameObject> children) {
    ...
    public void translate(float xTranslation, float yTranslation, float zTranslation) {
        ...
        this.children.forEach(child -> child.transform.translate(xTranslation, yTranslation, zTranslation));
    }
