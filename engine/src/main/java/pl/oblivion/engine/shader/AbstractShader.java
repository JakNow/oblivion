...
public abstract class AbstractShader {
  ...
  private final Logger logger = LogManager.getLogger(AbstractShader.class);
  private int programID;

  public AbstractShader(MyFile vertexFile, MyFile fragmentFile, String... inVariables) {
  ...
  private int loadShader(MyFile file, int type) {
    ...
    try {
      shaderSource.append(file.getReader().lines().collect(Collectors.toList()));
      file.closeReader();
    } catch (Exception e) {
